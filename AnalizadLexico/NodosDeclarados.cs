...
namespace AnalizadLexico
{
    public class NodosDeclarados
    {
        ...
        public NodosDeclarados(String Nodo, String abierto, String identificador_variable, String com1, String tipo_vo, String com2, String etiqueta, String cerrado)
        {
